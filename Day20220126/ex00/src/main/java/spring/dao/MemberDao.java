...
//				});
	...
	public int count() { // 어차피 결과가 반드시 하나인 경우
	...
	public void update(Member member) {
		// DB의 정보를 삽입,수정,삭제 기능
		int cnt = jdbcTemplate.update("UPDATE members SET name=?,password=? WHERE email=?", member.getName(),
...
//	}
	...
	public List<Member> selectByRegdate(Date from, Date to) {
		List<Member> list = jdbcTemplate.query(
				"SELECT * FROM MEMBERS WHERE REGDATE BETWEEN ? AND ? ORDER BY REGDATE ASC", new RowMapper<Member>() {
